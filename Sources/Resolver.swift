...
public protocol Resolver {
    ...
    ///            the service type and 1 argument is found.
    func throwsResolve<Service, Arg1>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, 1 argument and name is found.
    func throwsResolve<Service, Arg1>(
        _ serviceType: Service.Type,
        name: String?,
        argument: Arg1) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 2 arguments is found.
    func throwsResolve<Service, Arg1, Arg2>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 2 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 3 arguments is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 3 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 4 arguments is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 4 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 5 arguments is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 5 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 6 arguments is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 6 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 7 arguments is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 7 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 8 arguments is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 8 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7, _ arg8: Arg8) throws -> Service
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 9 arguments is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9>(
        _ serviceType: Service.Type,
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 9 arguments and name is found.
    func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7, _ arg8: Arg8, _ arg9: Arg9) throws -> Service
