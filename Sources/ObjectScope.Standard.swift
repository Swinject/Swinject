...
extension ObjectScope {
    ...
    public static let transient = ObjectScope(storageFactory: { return TransientStorage() }, description: "transient")
    ...
    public static let graph = ObjectScope(storageFactory: { return PermanentStorage() }, description: "graph")

    /// An instance provided by the `Container` is shared within the `Container` and its child `Containers`.
    public static let container = ObjectScope(storageFactory: { return PermanentStorage() }, description: "container")
    ...
    public static let weak = ObjectScope(storageFactory: { return WeakStorage() }, description: "weak")
}
