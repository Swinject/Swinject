...
extension Container {
    ...
    ///            the service type and 1 argument is found in the `Container`.
    public func throwsResolve<Service, Arg1>(
        _ serviceType: Service.Type,
        argument: Arg1) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, argument: argument)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, 1 argument and name is found in the `Container`.
    public func throwsResolve<Service, Arg1>(
        _ serviceType: Service.Type,
        name: String?,
        argument: Arg1) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, argument: argument) else {
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 2 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 2 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 3 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2, arg3)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 3 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2, arg3) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 4 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 4 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2, arg3, arg4) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 5 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 5 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2, arg3, arg4, arg5) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 6 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 6 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2, arg3, arg4, arg5, arg6) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 7 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 7 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 8 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7, _ arg8: Arg8) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 8 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7, _ arg8: Arg8) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type and list of 9 arguments is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9>(
        _ serviceType: Service.Type,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7, _ arg8: Arg8, _ arg9: Arg9) throws -> Service
    {
        return try throwsResolve(serviceType, name: nil, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)
    }
    ...
    ///
    /// - Returns: The resolved service type instance, or exception (ResolverError) if no registration for
    ///            the service type, list of 9 arguments and name is found in the `Container`.
    public func throwsResolve<Service, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, Arg9>(
        _ serviceType: Service.Type,
        name: String?,
        arguments arg1: Arg1, _ arg2: Arg2, _ arg3: Arg3, _ arg4: Arg4, _ arg5: Arg5, _ arg6: Arg6, _ arg7: Arg7, _ arg8: Arg8, _ arg9: Arg9) throws -> Service
    {
        guard let resolved: Service = resolve(serviceType, name: name, arguments: arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) else {
            throw ResolverError.cantResolve(type: serviceType, name: name)
        }
        return resolved
    }
