    ...
    override func spec() {
        describe("Without name") {
            it("equals with the same factory type.") {
                typealias FactoryType0Args = Container -> AnimalType
                ...
                typealias FactoryType2Args = (Container, String, Bool) -> AnimalType
            ...
            it("does not equal with different service types in factory types.") {
                typealias PersonFactoryType = Container -> PersonType
                typealias AnimalFactoryType = Container -> AnimalType
            ...
            it("does not equal with different arg types in factory types.") {
                typealias FactoryType1Arg = (Container, String) -> AnimalType
                typealias FactoryType2Args = (Container, String, Bool) -> AnimalType
                ...
                typealias FactoryTypeStringBoolArgs = (Container, String, Bool) -> AnimalType
                typealias FactoryTypeStringIntArgs = (Container, String, Int) -> AnimalType
