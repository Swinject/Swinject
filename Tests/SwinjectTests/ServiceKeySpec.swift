    ...
    override func spec() {
        describe("Without name") {
            it("equals with the same factory type.") {
                typealias FactoryType0Args = (Resolver) -> AnimalType
                ...
                typealias FactoryType2Args = (Resolver, String, Bool) -> AnimalType
            ...
            it("does not equal with different service types in factory types.") {
                typealias PersonFactoryType = (Resolver) -> PersonType
                typealias AnimalFactoryType = (Resolver) -> AnimalType
            ...
            it("does not equal with different arg types in factory types.") {
                typealias FactoryType1Arg = (Resolver, String) -> AnimalType
                typealias FactoryType2Args = (Resolver, String, Bool) -> AnimalType
                ...
                typealias FactoryTypeStringBoolArgs = (Resolver, String, Bool) -> AnimalType
                typealias FactoryTypeStringIntArgs = (Resolver, String, Int) -> AnimalType
